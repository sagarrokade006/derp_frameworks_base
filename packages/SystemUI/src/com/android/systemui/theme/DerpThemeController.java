...
public class DerpThemeController {

    private static final String TAG = "DerpThemeController";
    private final ContentResolver mContentResolver;
    private final Handler mBackgroundHandler;

    public DerpThemeController(ContentResolver contentResolver, Handler backgroundHandler) {
